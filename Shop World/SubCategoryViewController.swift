...
class SubCategoryViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, NSXMLParserDelegate {
    ...
    var currentSubcategory:Subcategoria = Subcategoria();
    var listSubcategories:[Subcategoria] = [];
    ...
    override func viewDidAppear(animated: Bool) {
        if (!isLoading) {
            ...
            parser = NSXMLParser(contentsOfURL: (NSURL(string: "http://shoptheworld.labstoreshopper.com/api/markers/api_stw.php?p=getSubtacategories&categoria=\(subcategorias[currentCategory])&language=\(languageCode)")))!;
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        var subcategoria = listSubcategories[indexPath.row];
        
        cell.backgroundColor = categoryColors[currentCategory];
        cell.imageCell.image = UIImage(named: "subCat\(subcategoria.id!)");
        cell.textCategory.text = subcategoria.nombre?.uppercaseString;
        
//        let baseURLImages:String = "http://shoptheworld.labstoreshopper.com/api/markers/uploads/subcategory/";
//
//        let urlString:String = "\(baseURLImages)\(subcategoria.id!).png";
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "productSegue" {
            var producto = segue.destinationViewController as! ProductoViewController;
            let cell = sender as! UICollectionViewCell
            let indexPath = collectionView.indexPathForCell(cell)
            
            producto.currentSubcategory = listSubcategories[cellSelected].id!.toInt();
            producto.currentCategory = currentCategory;
            producto.isLoading = false;
            producto.title = listSubcategories[cellSelected].nombre?.uppercaseString;
        }
    }
    ...
    func parser(parser: NSXMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        ...
        switch(elementName){
        case "id":
            currentSubcategory.id = txtNode as String!;
            break;
        case "nombre":
            currentSubcategory.nombre = txtNode as String!;
            break;
        case "subcategoria":
            listSubcategories.append(currentSubcategory);
            break;
        default:
